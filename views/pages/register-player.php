        ...
        <form method="POST" action="<?= url('/register/player') ?>" enctype="multipart/form-data">
            ...
            <div class="grid grid-2 gap-4">
                <div class="form-group">
                    ...
                    <input class="form-input" type="text" id="first_name" name="first_name" placeholder="e.g. Allstar" required>
                </div>
                <div class="form-group">
                    <label class="form-label" for="last_name">Last Name</label>
                    <input class="form-input" type="text" id="last_name" name="last_name" placeholder="e.g. Momba" required>
                </div>
            </div>
            
            <div class="form-group">
                <label class="form-label" for="email">Email Address</label>
                <input class="form-input" type="email" id="email" name="email" placeholder="e.g. allstarmomba@example.com" required>
            </div>
            ...
            <div class="grid grid-2 gap-4">
                <div class="form-group">
                    ...
                    <input class="form-input" type="text" id="nationality" name="nationality" placeholder="e.g. Malawian" required>
                </div>
                <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-input" type="tel" id="phone" name="phone" placeholder="e.g. +265 888 123 456" required>
            </div>
            
            <button type="submit" class="btn btn-primary btn-block" style="background-color: green;color: #ffffff">Register as Player</button>
        </form>
    </div>
</div>
