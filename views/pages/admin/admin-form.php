<div class="page-header mb-4">
    <div class="flex items-center gap-3">
        <a  href="<?= url('/admin') ?>"  class="btn btn-sm btn-light text-muted hover-bg-light rounded-pill px-3 shadow-sm"><i class="ph ph-arrow-left mr-1"></i> Back to Dashboard</a>
    </div>
</div>
...
<div class="card max-w-2xl mx-auto shadow-lg border-0 rounded-xl overflow-hidden">
    ...
    <div class="card-body p-5">
        <form  action="<?= url('/admin/admins/create') ?>"  method="POST">
            ...
            <div class="border-top border-light pt-4 mt-5 flex justify-end gap-3">
                <a  href="<?= url('/admin') ?>"  class="btn btn-light text-dark font-medium rounded-pill px-5 py-2">Cancel</a>
